...
const routes: Routes = [
  ...
  {path:'productregister',component:ProductregistrationComponent,canActivate:[adminGuard]},
  {path:'productmanage',component:ProductmanageComponent,canActivate:[adminGuard]},
